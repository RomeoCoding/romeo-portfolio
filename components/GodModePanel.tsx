...
const GodModePanel: React.FC = () => {
    ...
    return (
        <div className="god-mode-panel text-[var(--text-muted-color)]">
            <h3 className="text-lg font-bold text-[var(--primary-color)] mb-4 text-center">{GOD_MODE_DATA.panelTitle}</h3>
            
            <div className="space-y-4">
                {/* Matrix Speed */}
                <div>
                    <label htmlFor="matrix-speed" className="text-sm font-medium flex items-center gap-2"><SlidersHorizontalIcon className="w-4 h-4" /> {GOD_MODE_DATA.matrixSpeed}</label>
                    <input
                        id="matrix-speed"
                        type="range"
                        min="1"
                ...
                {/* Glitch Intensity */}
                <div>
                    <label htmlFor="glitch-intensity" className="text-sm font-medium flex items-center gap-2"><SlidersHorizontalIcon className="w-4 h-4" /> {GOD_MODE_DATA.glitchIntensity}</label>
                    <input
                        id="glitch-intensity"
                        type="range"
                        min="0"
                ...
                {/* Color Theme */}
                <div>
                     <label className="text-sm font-medium flex items-center gap-2 mb-2"><PaintBrushIcon className="w-4 h-4" /> {GOD_MODE_DATA.accentColor}</label>
                 ...
                 {/* Disable God Mode */}
                  <div>
                    ...
                    >
                        <PowerIcon className="w-4 h-4" /> {GOD_MODE_DATA.disable}
                    </button>
                 </div>
            </div>
        </div>
